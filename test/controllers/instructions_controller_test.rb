...
class InstructionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create instruction" do
    assert_difference('Instruction.count') do
      post instructions_url, params: { instruction: { description: @instruction.description, guide_id: @instruction.guide_id } }, as: :json
    end
  ...
  test "should update instruction" do
    patch instruction_url(@instruction), params: { instruction: { description: @instruction.description, guide_id: @instruction.guide_id } }, as: :json
    assert_response 200
  end
